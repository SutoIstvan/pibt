...
<body>
  {{-- <body data-bs-theme="dark"> --}}
      ...
      <div class="row flex-lg-row-reverse align-items-center g-0 py-0">
        ...
        <div class="col-lg-6 mt-xs-3">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-2" data-aos="fade-up" data-aos-duration="2000">
            <button type="button" class="btn btn-outline-primary btn-lg">{{__('menu.details')}}</button>
            <button type="button" class="btn btn-outline-secondary btn-lg">{{__('menu.request_a_quote')}}</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="container col-xl-12 col-xxl-12 " data-aos="fade-up">
          ...
          <div class="col-md-10 mx-auto col-lg-6">
            <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
              ...
              <div class="form-floating mb-3">
                ...
                <label for="floatingPassword">{{__('menu.mail')}}</label>
              </div>
              <div class="form-group">
                <label for="message" class="form-label ms-2">{{__('menu.short_decription_message')}}</label>
                <textarea id="inputMessage" id="message" class="form-control" rows="2"></textarea>
              </div>
          ...
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-6 col-sm-4 col-md-2 mb-4 mb-md-0">
              ...
              <div class="img-fluid text-gray-600 mb-2 mb-md-0" data-aos="fade-up" data-aos-delay="200">
                ...
                <img src="/assets/logo/ros-atom-logo-2.png" height="95px" alt="">
