  ...
  <div class="row flex-lg-row-reverse align-items-center g-0 py-0">
    ...
    <div class="container  pb-5">
        ...
        <div class="rounded">
            ...
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-1" class="text-decoration-none">1. Bevezetés</a></h3>
            <p class="lead mb-3"><a href="#subchapter-1-1" class="text-decoration-none text-body">1.1 A digitális dokumentumkezelés szerepe a vállalkozásoknál</a><br /><a href="#subchapter-1-2" class="text-decoration-none text-body">1.2 Az Okm Business rendszer célja</a><br /><a href="#subchapter-1-3" class="text-decoration-none text-body">1.3 Milyen problémákat old meg</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-2" class="text-decoration-none">2. Rendszer áttekintés</a></h3>
            <p class="lead mb-3"><a href="#subchapter-2-1" class="text-decoration-none text-body">2.1 Az Okm Business felépítése</a><br /><a href="#subchapter-2-2" class="text-decoration-none text-body">2.2 Fő funkcionális területek</a><br /><a href="#subchapter-2-3" class="text-decoration-none text-body">2.3 Felhasználási területek (KKV, ipar, szolgáltatás)</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-3" class="text-decoration-none">3. Fő funkciók</a></h3>
            <p class="lead mb-3"><a href="#subchapter-3-1" class="text-decoration-none text-body">3.1 Dokumentumtár és fájlkezelés</a><br /><a href="#subchapter-3-2" class="text-decoration-none text-body">3.2 Verziókezelés és előzmények</a><br /><a href="#subchapter-3-3" class="text-decoration-none text-body">3.3 Metaadatok és címkézés</a><br /><a href="#subchapter-3-4" class="text-decoration-none text-body">3.4 Jogosultságkezelés és hozzáférés</a><br /><a href="#subchapter-3-5" class="text-decoration-none text-body">3.5 Keresés és szűrés (teljes szöveges keresés)</a><br /><a href="#subchapter-3-6" class="text-decoration-none text-body">3.6 Automatikus archiválás</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-4" class="text-decoration-none">4. Dokumentumkezelési folyamatok</a></h3>
            <p class="lead mb-3"><a href="#subchapter-4-1" class="text-decoration-none text-body">4.1 Dokumentumok feltöltése és rendszerezése</a><br /><a href="#subchapter-4-2" class="text-decoration-none text-body">4.2 Jóváhagyási folyamatok (workflow)</a><br /><a href="#subchapter-4-3" class="text-decoration-none text-body">4.3 Verziókövetés és audit napló</a><br /><a href="#subchapter-4-4" class="text-decoration-none text-body">4.4 Iratkezelési szabályok és struktúra</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-5" class="text-decoration-none">5. CRM irányultság és ügyfélkezelés</a></h3>
            <p class="lead mb-3"><a href="#subchapter-5-1" class="text-decoration-none text-body">5.1 Ügyfélmappák és struktúra</a><br /><a href="#subchapter-5-2" class="text-decoration-none text-body">5.2 Projektek és ügyfélhez kötött dokumentumok</a><br /><a href="#subchapter-5-3" class="text-decoration-none text-body">5.3 Státuszkezelés és nyomon követés</a><br /><a href="#subchapter-5-4" class="text-decoration-none text-body">5.4 Kapcsolattartási adatok kezelése</a><br /><a href="#subchapter-5-5" class="text-decoration-none text-body">5.5 Ajánlatok, szerződések kezelése</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-6" class="text-decoration-none">6. Adminisztrációs felület</a></h3>
            <p class="lead mb-3"><a href="#subchapter-6-1" class="text-decoration-none text-body">6.1 Felhasználók kezelése</a><br /><a href="#subchapter-6-2" class="text-decoration-none text-body">6.2 Jogosultsági rendszer (role alapú hozzáférés)</a><br /><a href="#subchapter-6-3" class="text-decoration-none text-body">6.3 Csoportok és szervezeti egységek</a><br /><a href="#subchapter-6-4" class="text-decoration-none text-body">6.4 Naplózás és audit</a><br /><a href="#subchapter-6-5" class="text-decoration-none text-body">6.5 Rendszerbeállítások</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-7" class="text-decoration-none">7. Automatizálás és workflow</a></h3>
            <p class="lead mb-3"><a href="#subchapter-7-1" class="text-decoration-none text-body">7.1 Automatizált folyamatok</a><br /><a href="#subchapter-7-2" class="text-decoration-none text-body">7.2 Esemény alapú műveletek</a><br /><a href="#subchapter-7-3" class="text-decoration-none text-body">7.3 Jóváhagyási láncok kialakítása</a><br /><a href="#subchapter-7-4" class="text-decoration-none text-body">7.4 Értesítések és státuszváltások</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-8" class="text-decoration-none">8. Integrációs lehetőségek</a></h3>
            <p class="lead mb-3"><a href="#subchapter-8-1" class="text-decoration-none text-body">8.1 Külső rendszerekkel való kapcsolat</a><br /><a href="#subchapter-8-2" class="text-decoration-none text-body">8.2 API alapú integráció</a><br /><a href="#subchapter-8-3" class="text-decoration-none text-body">8.3 Irodai szoftverekkel való együttműködés</a><br /><a href="#subchapter-8-4" class="text-decoration-none text-body">8.4 E-mail integráció</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-9" class="text-decoration-none">9. Keresés és riportálás</a></h3>
            <p class="lead mb-3"><a href="#subchapter-9-1" class="text-decoration-none text-body">9.1 Speciális keresési lehetőségek</a><br /><a href="#subchapter-9-2" class="text-decoration-none text-body">9.2 Mentett keresések</a><br /><a href="#subchapter-9-3" class="text-decoration-none text-body">9.3 Riportok és kimutatások</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-10" class="text-decoration-none">10. Biztonság és adatvédelem</a></h3>
            <p class="lead mb-3"><a href="#subchapter-10-1" class="text-decoration-none text-body">10.1 Adatbiztonsági megoldások</a><br /><a href="#subchapter-10-2" class="text-decoration-none text-body">10.2 Hozzáférés szabályozás</a><br /><a href="#subchapter-10-3" class="text-decoration-none text-body">10.3 Mentések és visszaállítás</a><br /><a href="#subchapter-10-4" class="text-decoration-none text-body">10.4 Jogszabályi megfelelés</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-11" class="text-decoration-none">11. Rendszer architektúra</a></h3>
            <p class="lead mb-3"><a href="#subchapter-11-1" class="text-decoration-none text-body">11.1 Szerver oldali működés</a><br /><a href="#subchapter-11-2" class="text-decoration-none text-body">11.2 Skálázhatóság</a><br /><a href="#subchapter-11-3" class="text-decoration-none text-body">11.3 Telepítési lehetőségek (helyi / felhő)</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-12" class="text-decoration-none">12. Használati példák</a></h3>
            <p class="lead mb-3"><a href="#subchapter-12-1" class="text-decoration-none text-body">12.1 Dokumentumkezelés cégen belül</a><br /><a href="#subchapter-12-2" class="text-decoration-none text-body">12.2 Pályázatkezelés</a><br /><a href="#subchapter-12-3" class="text-decoration-none text-body">12.3 Projektmenedzsment támogatás</a><br /><a href="#subchapter-12-4" class="text-decoration-none text-body">12.4 Szerződéskezelés</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-13" class="text-decoration-none">13. Előnyök és üzleti érték</a></h3>
            <p class="lead mb-3"><a href="#subchapter-13-1" class="text-decoration-none text-body">13.1 Időmegtakarítás</a><br /><a href="#subchapter-13-2" class="text-decoration-none text-body">13.2 Átláthatóság növelése</a><br /><a href="#subchapter-13-3" class="text-decoration-none text-body">13.3 Hibák csökkentése</a><br /><a href="#subchapter-13-4" class="text-decoration-none text-body">13.4 Digitalizáció támogatása</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-14" class="text-decoration-none">14. Bevezetési folyamat</a></h3>
            <p class="lead mb-3"><a href="#subchapter-14-1" class="text-decoration-none text-body">14.1 Igényfelmérés</a><br /><a href="#subchapter-14-2" class="text-decoration-none text-body">14.2 Testreszabás</a><br /><a href="#subchapter-14-3" class="text-decoration-none text-body">14.3 Oktatás</a><br /><a href="#subchapter-14-4" class="text-decoration-none text-body">14.4 Élesítés</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-15" class="text-decoration-none">15. Támogatás és üzemeltetés</a></h3>
            <p class="lead mb-3"><a href="#subchapter-15-1" class="text-decoration-none text-body">15.1 Rendszerkarbantartás</a><br /><a href="#subchapter-15-2" class="text-decoration-none text-body">15.2 Frissítések</a><br /><a href="#subchapter-15-3" class="text-decoration-none text-body">15.3 Ügyféltámogatás</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-16" class="text-decoration-none">16. Technikai követelmények</a></h3>
            <p class="lead mb-3"><a href="#subchapter-16-1" class="text-decoration-none text-body">16.1 Hardver igények</a><br /><a href="#subchapter-16-2" class="text-decoration-none text-body">16.2 Szoftver környezet</a><br /><a href="#subchapter-16-3" class="text-decoration-none text-body">16.3 Hálózati követelmények</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-17" class="text-decoration-none">17. Bővíthetőség és testreszabás</a></h3>
            <p class="lead mb-3"><a href="#subchapter-17-1" class="text-decoration-none text-body">17.1 Egyedi fejlesztések</a><br /><a href="#subchapter-17-2" class="text-decoration-none text-body">17.2 Moduláris bővítés</a><br /><a href="#subchapter-17-3" class="text-decoration-none text-body">17.3 Céges igényekhez igazítás</a></p>
            <h3 class="mt-5 mb-4 text-primary"><a href="#chapter-18" class="text-decoration-none">18. Összefoglalás</a></h3>
            <p class="lead mb-3"><a href="#subchapter-18-1" class="text-decoration-none text-body">18.1 Miért az Okm Business</a><br /><a href="#subchapter-18-2" class="text-decoration-none text-body">18.2 Versenyelőnyök</a><br /><a href="#subchapter-18-3" class="text-decoration-none text-body">18.3 Jövőbeni fejlesztési irányok</a></p>
            <h3 id="chapter-1" class="mt-5 mb-4 text-primary">1. Bevezetés</h3>
            <h3 class="lead mb-3"><strong id="subchapter-1-1">1.1 A digitális dokumentumkezelés szerepe a vállalkozásoknál</strong></h3>
            ...
            <p class="lead mb-3"><strong id="subchapter-1-2">1.2 Az Okm Business rendszer célja</strong></p>
            <div class="row align-items-center">
                    <div class="col-md-6">
            ...
            <p class="lead mb-3">Az Okm Business nem egy általános fájlkezelő, hanem egy <strong>folyamatközpontú vállalati rendszer</strong>, amely támogatja a napi operatív működést és a vezetői döntéshozatalt is.</p>
            <h3 class="lead mb-3"><strong id="subchapter-1-3">1.3 Milyen problémákat old meg</strong></h3>
            <div class="row align-items-center">
                <div class="col-md-6">
            ...
            <h3 id="chapter-2" class="mb-3 text-primary mt-5"><strong>2. Rendszer áttekintés</strong></h3>
            <strong id="subchapter-2-1">2.1 Az Okm Business felépítése</strong>
            ...
            <p class="lead mb-3"><strong id="subchapter-2-2">2.2 Fő funkcionális területek</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-2-3">2.3 Felhasználási területek</strong></p>
            ...
            <h3 id="chapter-3" class="mt-5 mb-4 text-primary"><strong>3. Fő funkciók</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-3-1">3.1 Dokumentumtár és fájlkezelés</strong></p>
            <p class="lead mb-3">
            <div class="row align-items-center">
            ...
            <p class="lead mb-3"><strong id="subchapter-3-2">3.2 Verziókezelés és előzmények</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-3-3">3.3 Metaadatok és címkézés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-3-4">3.4 Jogosultságkezelés és hozzáférés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-3-5">3.5 Keresés és szűrés (teljes szöveges keresés)</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-3-6">3.6 Automatikus archiválás</strong></p>
            ...
            <h3 id="chapter-4" class="mt-5 mb-3 text-primary"><strong>4. Dokumentumkezelési folyamatok</strong></h3>
            <p class="lead mb-3"><img src="/images/okm/15.jpeg" class="img-fluid my-4 rounded" alt="OKM ábra" /><strong id="subchapter-4-1">4.1 Dokumentumok feltöltése és rendszerezése</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-4-2">4.2 Jóváhagyási folyamatok (workflow)</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-4-3">4.3 Verziókövetés és audit napló</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-4-4">4.4 Iratkezelési szabályok és struktúra</strong></p>
            ...
            <h3 id="chapter-5" class="mt-5 mb-3 text-primary"><strong>5. CRM irányultság és ügyfélkezelés</strong></h3>
            <p class="lead mb-3"><img src="/images/okm/19.jpeg" class="img-fluid my-4 rounded" alt="OKM ábra" /></p>
            <p class="lead mb-3"><strong id="subchapter-5-1">5.1 Ügyfélmappák és struktúra</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-5-2">5.2 Projektek és ügyfélhez kötött dokumentumok</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-5-3">5.3 Státuszkezelés és nyomon követés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-5-4">5.4 Kapcsolattartási adatok kezelése</strong></p>
            ...
            <p class="lead mb-3"><img src="/images/okm/22.jpeg" class="img-fluid my-4 rounded" alt="OKM ábra" /><strong id="subchapter-5-5">5.5 Ajánlatok és szerződések kezelése</strong></p>
            ...
            <h3 id="chapter-6" class="mt-5 mb-3 text-primary"><strong>6. Adminisztrációs felület</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-6-1">6.1 Felhasználók kezelése</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-6-2">6.2 Jogosultsági rendszer (role alapú hozzáférés)</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-6-3">6.3 Csoportok és szervezeti egységek</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-6-4">6.4 Naplózás és audit</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-6-5">6.5 Rendszerbeállítások</strong></p>
            ...
            <h3 id="chapter-7" class="mt-5 mb-3 text-primary"><strong>7. Automatizálás és workflow</strong></h3>
            <p class="lead mb-3"><img src="/images/okm/23.jpeg" class="img-fluid my-4 rounded" alt="OKM ábra" /><strong id="subchapter-7-1">7.1 Automatizált folyamatok</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-7-2">7.2 Esemény alapú műveletek</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-7-3">7.3 Jóváhagyási láncok kialakítása</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-7-4">7.4 Értesítések és státuszváltások</strong></p>
            ...
            <h3 id="chapter-8" class="mt-5 mb-3 text-primary"><strong>8. Integrációs lehetőségek</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-8-1">8.1 Külső rendszerekkel való kapcsolat</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-8-2">8.2 API alapú integráció</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-8-3">8.3 Irodai szoftverekkel való együttműködés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-8-4">8.4 E-mail integráció</strong></p>
            ...
            <h3 id="chapter-9" class="mt-5 mb-3 text-primary"><strong>9. Keresés és riportálás</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-9-1">9.1 Speciális keresési lehetőségek</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-9-2">9.2 Mentett keresések</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-9-3">9.3 Riportok és kimutatások</strong></p>
            ...
            <h3 id="chapter-10" class="mt-5 mb-3 text-primary"><strong>10. Biztonság és adatvédelem</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-10-1">10.1 Adatbiztonsági megoldások</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-10-2">10.2 Hozzáférés szabályozás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-10-3">10.3 Mentések és visszaállítás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-10-4">10.4 Jogszabályi megfelelés</strong></p>
            ...
            <h3 id="chapter-11" class="mt-5 mb-3 text-primary"><strong>11. Rendszer architektúra</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-11-1">11.1 Szerver oldali működés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-11-2">11.2 Skálázhatóság</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-11-3">11.3 Telepítési lehetőségek (helyi / felhő)</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-11-4">11.4 Biztonsági architektúra</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-11-5">11.5 Integrált működési modell</strong></p>
            ...
            <h3 id="chapter-12" class="mt-5 mb-3 text-primary"><strong>12. Használati példák</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-12-1">12.1 Dokumentumkezelés cégen belül</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-2">12.2 Pályázatkezelés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-3">12.3 Projektmenedzsment támogatás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-4">12.4 Szerződéskezelés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-5">12.5 Ügyfélkezelés dokumentum alapon</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-6">12.6 Belső folyamatok digitalizálása</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-12-7">12.7 Több telephelyes működés támogatása</strong></p>
            ...
            <h3 id="chapter-13" class="mt-5 mb-3 text-primary"><strong>13. Előnyök és üzleti érték</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-13-1">13.1 Időmegtakarítás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-2">13.2 Átláthatóság növelése</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-3">13.3 Hibák csökkentése</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-4">13.4 Digitalizáció támogatása</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-5">13.5 Költségcsökkentés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-6">13.6 Versenyelőny</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-13-7">13.7 Skálázható működés</strong></p>
            ...
            <h3 id="chapter-14" class="mt-5 mb-3 text-primary"><strong>14. Bevezetési folyamat</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-14-1">14.1 Igényfelmérés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-14-2">14.2 Testreszabás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-14-3">14.3 Adatmigráció</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-14-4">14.4 Oktatás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-14-5">14.5 Élesítés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-14-6">14.6 Utókövetés és finomhangolás</strong></p>
            ...
            <h3 id="chapter-15" class="mt-5 mb-3 text-primary"><strong>15. Támogatás és üzemeltetés</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-15-1">15.1 Rendszerkarbantartás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-15-2">15.2 Frissítések</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-15-3">15.3 Ügyféltámogatás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-15-4">15.4 Monitoring és felügyelet</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-15-5">15.5 Biztonsági üzemeltetés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-15-6">15.6 SLA és rendelkezésre állás</strong></p>
            ...
            <h3 id="chapter-16" class="mt-5 mb-3 text-primary"><strong>16. Technikai követelmények</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-16-1">16.1 Hardver igények</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-16-2">16.2 Szoftver környezet</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-16-3">16.3 Hálózati követelmények</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-16-4">16.4 Biztonsági követelmények</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-16-5">16.5 Mentési infrastruktúra</strong></p>
            ...
            <h3 id="chapter-17" class="mt-5 mb-3 text-primary"><strong>17. Bővíthetőség és testreszabás</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-17-1">17.1 Egyedi fejlesztések</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-17-2">17.2 Moduláris bővítés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-17-3">17.3 Céges igényekhez igazítás</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-17-4">17.4 Integráció alapú bővítés</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-17-5">17.5 Folyamatos fejleszthetőség</strong></p>
            ...
            <h3 id="chapter-18" class="mt-5 mb-3 text-primary"><strong>18. Összefoglalás</strong></h3>
            <p class="lead mb-3"><strong id="subchapter-18-1">18.1 Miért az Okm Business</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-18-2">18.2 Versenyelőnyök</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-18-3">18.3 Jövőbeni fejlesztési irányok</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-18-4">18.4 Kinek ajánlott</strong></p>
            ...
            <p class="lead mb-3"><strong id="subchapter-18-5">18.5 Üzleti érték összefoglalva</strong></p>
